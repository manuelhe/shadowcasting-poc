...
export default function DecayedPaintShowcasePage() {
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-neutral-950">
      {/* Background Decoupled Shadow Engine */}
      <ShadowBackground
        basePlate="/images/decayedpaint-background.webp"
        caster="/images/shadow-2.webp"
        className="absolute inset-0"
        tier="auto"
        motion={{ preset: "energetic", ambient: true, maxDisplacementPx: 45 }}
        shadowColor="#080808"
        shadowOpacity={0.85}
        penumbra={24}
      />
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-24 flex flex-col justify-between pointer-events-none select-none">
