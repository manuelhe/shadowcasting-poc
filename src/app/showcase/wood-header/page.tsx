...
export default function WoodHeaderShowcasePage() {
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-neutral-950">
      {/* Background Shadowcasting Layer */}
      <ShadowBackground
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-24 sm:py-32 flex flex-col items-center text-center pointer-events-none select-none">
